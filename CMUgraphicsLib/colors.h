...
public:
	...
	bool operator==(color b) {
		return (ucRed == b.ucRed && ucGreen == b.ucGreen && ucBlue == b.ucBlue);
	}
...
const color PALE = color(217, 251, 249);
const color LINE = color(61, 161, 154);
const color DOWN = color(152, 186, 183);
